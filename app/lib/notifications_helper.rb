    ...
    def new_answer_params(resource)
      {
        ...
        answer_path: resume_path(resource.resume, locale: I18n.locale, anchor: "answer-#{resource.id}")
      }
    end
    ...
    def new_comment_params(resource)
      {
        user: resource.user,
        user_path: user_path(resource.user, locale: I18n.locale),
        comment_path: resume_path(resource.resume, locale: I18n.locale, anchor: "comment-#{resource.id}")
      }
    end
