...
// это просто ошибки все остальное
    ...
    public Object handleMatchingPasswordsException(MatchingPasswordsException ex,
                                                   HttpServletRequest request,
                                                   RedirectAttributes redirectAttributes) {

        Map<String, String> errors = Map.of("repeatPassword", ex.getMessage());
    ...
    public Object handleWrongPasswordException(WrongPasswordException ex,
                                               HttpServletRequest request,
                                               RedirectAttributes redirectAttributes) {
    ...
    public Object handleInvalidTokenTypeException(InvalidTokenTypeException ex,
                                                  HttpServletRequest request,
                                                  RedirectAttributes redirectAttributes) {

        Map<String, String> errors = Map.of("refreshToken", ex.getMessage());
