  ...
  translation: {
    ...
    homePage: {
      ...
      pricing: {
        ...
        subtitle: 'Зарегистрируйтесь, подключите НН-профиль и попробуйте сервис в деле',
        ...
        plans: {
          month1: {
            ...
            price: '4900 ₽/мес',
            features: [
              'Подготовка и улучшение резюме',
              'Поиск и сбор релевантных вакансий',
              'Автоматизированные отклики',
              'Переписка с рекрутерами',
