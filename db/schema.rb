...
ActiveRecord::Schema.define(version: 20_190_922_153_508) do
  ...
  create_table 'notifications', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[resourceable_type resourceable_id], name: 'index_notifications_on_resourceable_type_and_resourceable_id'
