...
ActiveRecord::Schema[7.0].define(version: 20_230_221_221_505) do
  ...
  create_table 'notifications', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[resource_type resource_id], name: 'index_notifications_on_resource_type_and_resource_id'
  ...
  create_table 'resume_answer_likes', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[answer_id user_id], name: 'index_resume_answer_likes_on_answer_id_and_user_id', unique: true
  ...
  create_table 'resume_answers', force: :cascade do |t|
    ...
    t.index %w[user_id resume_id], name: 'index_resume_answers_on_user_id_and_resume_id', unique: true
